...
public class KameNet {
    ...
    private int _goodThreshold = 0;
    private int _mediumThreshold = 0;
    ...
    public void setGoodThreshold(int threshold) {
        _goodThreshold = threshold;
    }
    ...
    public void setMediumThreshold(int threshold) {
